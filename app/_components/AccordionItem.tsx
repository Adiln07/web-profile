  ...
  return (
    <div className="xl:max-w-[75em] lg:max-w-[55em] md:max-w-[45em] m-auto my-5 px-3">
      ...
      >
        ...
        <div
          className={`flex gap-1 roboto-font lg:text-sm text-xs font-medium ${
            isExpanded ? "text-white" : "text-[#222222]"
          }`}
        >
          <p
            className={`rounded-full border border-[#222222] px-2 py-1 ${
              isExpanded ? "bg-[#222222]" : "bg-[#f8f8f8]"
            }`}
          >
            {item.techStack[0]}
          </p>
      ...
      >
        <div className="overflow-hidden">
          <div className="md:flex gap-10">
            ...
            <div className="md:w-1/2 roboto-font">
              ...
              {item.url ? (
                <Link
                  href={item.url}
                  target="_blank"
                  className="flex items-center gap-2 w-fit bg-[#222222] border border-[#222222] px-2 py-0.5 rounded-full text-white mt-5"
                >
